...
class Vocab(object):
    ...
    """
    def __init__(self, src_vocab: VocabEntry, tgt_vocab: VocabEntry): #위의 class VocabEntry를 자료형으로 받음
        """ Init Vocab.
        @param src_vocab (VocabEntry): VocabEntry for source language
        @param tgt_vocab (VocabEntry): VocabEntry for target language
        """
        self.src = src_vocab # self.src는 VocabEntry의 method 사용할 수 있음
        self.tgt = tgt_vocab
...
if __name__ == '__main__':
    ...
    print('generated vocabulary, sou3rce %d words, target %d words' % (len(vocab.src), len(vocab.tgt)))
